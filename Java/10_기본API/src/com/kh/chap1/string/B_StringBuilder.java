...
public class B_StringBuilder {
	...
	public void method1() {
		// StringBuilder의 기본 생성자를 통해서 객체를 생성하면 16개의 문자를 저장할 수 있는 버퍼가 생성됨
		// StringBuilder의 생성자에 정수값을 전달해주면 해당 크기만큼의 버퍼가 지정됨
		// StringBuilder의 생성자에 문자열을 전달해주면 문자열의 크기 + 16의 버퍼 생성
	...
	public void method2() {
		...
		//   : start에서 end까지의 인덱스에 해당하는 문자열 삭제
		sb.delete(2, 5);
		...
		// 아래와 같이 메소드를 이어서 쓸 수 있음
		// 왜냐하면, 우리가 사용한 아래의 메소드들은 반환형이 StringBuilder이고
		//        실제 반환되는 결과값이 해당 객체의 주소값이기 때문
